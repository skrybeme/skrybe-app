    ...
    <S.Context>
      <S.Wrapper>
        <S.Editable>
          ...
          <div className="fixed">
            <div className="link" title="Editor settings">
              <i className="fas fa-cog"></i>
            </div>
            <div className="link" title="Tags">
              <i className="fas fa-tag"></i>
            </div>
            <div className="link" title="Writing progress & stats">
              <i className="fas fa-chart-pie"></i>
            </div>
            <div className="link" title="Generate story">
